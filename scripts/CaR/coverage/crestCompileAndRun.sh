...
${CILLY} -fprofile-arcs -ftest-coverage -O0 linked_temp.c -o executable.o --save-temps \
    --doCrestInstrument -I${CREST_ROOT}/include -I$CSMITH_RUNTIME -L${CREST_ROOT}/lib -lcrest -lstdc++ &&\
...
gcov linked_temp.c > /dev/null&&\
grep -A10000 ' This is a RANDOMLY GENERATED PROGRAM.' linked_temp.c.gcov | sed -e 's/:[ \t0-9]*:/:/'
